...
# - After DOI matching 7989 articles remain without disciplinary information.
# - This number is further reduced to 3929 by title matching.
# - Of these 3929 articles, 3374 are not in the external dataset as they are either corrections, retractions, or texts published by the PLOS ONE Staff.
# - Thus, only **555 articles** remain that are actually missing disciplines.
...
print("Breakdown of articles that are authored by PLOS ONE Staff:")
